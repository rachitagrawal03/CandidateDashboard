...
const Candidate = () => {
  const {handleAddButton, currentCandidates, handleNext, handlePrevious, totalPage, currentPage, handleSearch, filteredCandidates } = useContext(CandidateContext);
    ...
    <>
      <div className="border border-gray-400 m-1 p-10">
        <div className="flex justify-between items-center mt-10 mb-5 border">
          ...
          <div className="py-1">
            <button className="text-xl text-right font-bold text-white bg-green-400 px-2 py-1" onClick={handleAddButton}>
        ...
        <div className="flex justify-between items-center border mb-5">
          ...
          <div className="flex items-center">
            <div className="border border-gray-400 flex items-center rounded p-1 mx-1">
              ...
              <input type="text" placeholder="Search by Candidate, Email, Phone" className="outline-none w-[250px] " onChange={handleSearch} />
              {/* <h3 className="mx-2 text-gray-400">
                Search by Candidate, Email, Phone
              </h3> */}
            </div>
            ...
            <div className="flex items-center">
              <button className="border px-3 py-2 mx-2 text-green-700" disabled={currentPage===1} onClick={handlePrevious}>
                <TfiAngleLeft/>
              </button>
              <button className="border px-3 py-2 mx-2 text-green-700" disabled={currentPage===totalPage} onClick={handleNext}>
                <TfiAngleRight />
              </button>
